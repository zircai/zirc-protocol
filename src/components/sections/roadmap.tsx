            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <div className="relative">
                <div className="border-neon-green/30 border bg-black/50 p-6 rounded-lg hover:border-neon-green transition-colors duration-300 h-full">
                  <div className="text-neon-green mb-2 font-mono text-sm">PHASE 1 - Q1 2025</div>
              ...
              <div className="relative">
                <div className="border-neon-green/30 border bg-black/50 p-6 rounded-lg hover:border-neon-green transition-colors duration-300 h-full">
                  <div className="text-neon-green mb-2 font-mono text-sm">PHASE 2 - Q2 2025</div>
              ...
              <div className="relative">
                <div className="border-neon-green/30 border bg-black/50 p-6 rounded-lg hover:border-neon-green transition-colors duration-300 h-full">
                  <div className="text-neon-green mb-2 font-mono text-sm">PHASE 3 - Q3 2025</div>
              ...
              <div className="relative">
                <div className="border-neon-green/30 border bg-black/50 p-6 rounded-lg hover:border-neon-green transition-colors duration-300 h-full">
                  <div className="text-neon-green mb-2 font-mono text-sm">PHASE 4 - Q4 2025</div>
